...
//context path : 서버가 주소를 구분하기 위한 이름 (JSP02)

// 어노테이션 : 메타데이터라고 볼 수 있다
// 프로그램 실행 관점에서 보면 프로그램이 처리할 메인데이터가 아니라
// 실행 과정에서 데이터를 어떻게 처리할 것인지 알려주는 서브 데이터이다
// 자바 코드에 @를 사용해 주석처럼 달아 특수한 의미를 부여해준다
...
public class Servlet01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 현재 문서를 웹브라우저한테 UTF-8로 인코딩을 해서 보낸다
		
		response.setContentType("text/html; charset=UTF-8");
		// 웹브라우저에게 html 문서를 UFT-8로 해석하라는 뜻
